...
<?
	...
	$result = $DB->fetch();
?>
	<TD COLSPAN="4" class="hbottom_bold"><?=strip_tags(trim($result[0]))?></TD>
</TR>
</TABLE>
<br />
<?
...
<!-- 문항 보기 //-->
<!-- 문항 보기 수정부분 //-->
<FORM NAME="itemModi" METHOD="post" ACTION="procModiItem.php">
...
$myFCKeditor->Value    = $result[0];
//$myFCKeditor->Create() ;
?>
	<TR>
		<TD WIDTH="590" class="pad15"><?=$myFCKeditor->Create()?></TD>
	</TR>
	<tr>
		<td CLASS="hbottom_bold2">&nbsp;</td>
	</tr>
...
<TABLE border="0" width="590" cellpadding="0" cellspacing="0" style="border-top:solid 1px #9EB1DB">
	<TR>
		...
		<TD ALIGN="CENTER" WIDTH="250" class="hbottom2"><input type="text" name="myCorrect" value="<?=$result[1]?>" /></TD>
...
<TABLE border="0" width="590" cellpadding="0" cellspacing="0">
	<tr>
		<td align="right">[<a href="javascript:document.itemModi.submit()">수정</a>][<A HREF="javascript:history.go(-1)">취소</A>]</td>
	</tr>
</TABLE>
<?
