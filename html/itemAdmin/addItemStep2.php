<?php
/* =============================================================================
File : itemAdmin/addItemStep2.php
================================================================================
...
<FORM NAME="getItemStep2" ACTION="<?=URL_ROOT?>itemAdmin/procAddItem.php" METHOD="POST" ENCTYPE="multipart/form-data">
	<tr>
		<td colspan="2"><img src="<?=IMG_URL?>site/examadmin/title_8.gif" border="0"></td>
	</tr>
	<TR>
<?
// 문항입력 방식이 FORM이면
...
<TR>
	<TD align="right"><a href="javascript:getItemStep2.submit();"><img src="<?=IMG_URL?>site/icon/submit.gif"></a><!--<INPUT TYPE="submit">--></TD>
</TR>
